...
```
    ...
    GPS_lat GPS_lon GPS_time GPS_flag pressure time temperature temp_flag salinity sal_flag PAR PAR_flag fluorescence fluor_flag backscatter bbp_flag CDOM CDOM_flag latitude longitude latlon_flag DAC_U DAC_V 
...
par_sm = np.empty(shape=time_sm.shape)*np.nan
...
par_n = np.empty(shape=time_sm.shape)*np.nan
...
for i in range(0,nc.variables['time'].shape[0]):
    ...
    good_par = nc.variables['PAR_flag'][i,downcastinds] == 0
    ...
    par = nc.variables['PAR'][i,downcastinds]
    ...
    for j in range(0,maxpressureindex):        
        ...
        par_inds = np.logical_and(time_inds,good_par)
        par_sm[i*2,j] = np.mean(par[par_inds])
        par_n[i*2,j] = np.sum(par_inds)
    ...
    good_par = nc.variables['PAR_flag'][i,upcastinds] == 0
    ...
    par = nc.variables['PAR'][i,upcastinds]
    ...
    for j in range(0,maxpressureindex):        
        ...
        par_inds = np.logical_and(time_inds,good_par)
        par_sm[i*2+1,j] = np.mean(par[par_inds])
        par_n[i*2+1,j] = np.sum(par_inds)
...
```
    ...
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:27: RuntimeWarning: invalid value encountered in less
    ...
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:47: RuntimeWarning: invalid value encountered in less
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:48: RuntimeWarning: invalid value encountered in less
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:49: RuntimeWarning: invalid value encountered in less
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:106: RuntimeWarning: invalid value encountered in greater
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:107: RuntimeWarning: invalid value encountered in less
    ...
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:164: RuntimeWarning: invalid value encountered in less
    ...
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:224: RuntimeWarning: invalid value encountered in greater
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:225: RuntimeWarning: invalid value encountered in less
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:87: RuntimeWarning: invalid value encountered in greater
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:205: RuntimeWarning: invalid value encountered in greater
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:204: RuntimeWarning: Mean of empty slice
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:86: RuntimeWarning: Mean of empty slice



```python
# determine offset as the 5th percentile of all measurements below 400 db
...
```
    ...
    Fluorescence offset: 2.38e-02
    Backscatter offset: 1.80e-04
...
![png](Level2_SG579_JanApr_5m/output_10_1.png)
...
![png](Level2_SG579_JanApr_5m/output_11_1.png)
...
```python
plt.figure(figsize=(10,5))
plt.subplot(121); plt.hist(nc.variables['PAR'][:].ravel()[np.logical_and(nc.variables['PAR_flag'][:].ravel()==0,~np.isnan(nc.variables['PAR'][:].ravel()))],100);
plt.title('Before smoothing'); plt.xlabel(r'PAR ($\mu$Ein/m$^2$/s)')
plt.subplot(122); plt.hist(par_sm.ravel()[~np.isnan(par_sm.ravel())],100);
plt.title('After smoothing'); plt.xlabel(r'PAR ($\mu$Ein/m$^2$/s)');
```
...
![png](Level2_SG579_JanApr_5m/output_13_1.png)
...
![png](Level2_SG579_JanApr_5m/output_14_1.png)
...
![png](Level2_SG579_JanApr_5m/output_15_1.png)
...
![png](Level2_SG579_JanApr_5m/output_16_1.png)
...
for i in range(0,time_sm.shape[0]):
    ...
    no_data = np.where(par_n[i,:] == 0)[0]
    yes_data = np.where(par_n[i,:] > 0)[0]
    if yes_data.size == 0:
        par_sm[i,no_data] = np.nan
    else:
        if no_data.size != 0:
            par_sm[i,no_data] = np.interp(pressure[no_data],pressure[yes_data],par_sm[i,yes_data],left=np.nan,right=np.nan)
...
```
    ...
    /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ipykernel_launcher.py:68: RuntimeWarning: invalid value encountered in greater
...
![png](Level2_SG579_JanApr_5m/output_18_0.png)
...
![png](Level2_SG579_JanApr_5m/output_19_0.png)
...
![png](Level2_SG579_JanApr_5m/output_21_0.png)



```python
plt.figure(figsize=(16,3))
plt.title('PAR'); plt.ylim([1000,0])
plt.scatter(time_sm.ravel(),np.tile(pressure.reshape(1,-1),[time_sm.shape[0],1]).ravel(),s=1,c=np.log10(par_sm.ravel()),vmin=-5,vmax=-1,cmap=cmocean.cm.solar); plt.colorbar();
```


![png](Level2_SG579_JanApr_5m/output_22_0.png)
...
![png](Level2_SG579_JanApr_5m/output_23_0.png)
...
```
    ...
    [<matplotlib.lines.Line2D at 0x10a17db70>]




![png](Level2_SG579_JanApr_5m/output_25_1.png)
...
```
    ...
    [<matplotlib.lines.Line2D at 0x10a180518>]




![png](Level2_SG579_JanApr_5m/output_27_1.png)
...
![png](Level2_SG579_JanApr_5m/output_29_0.png)
...
NC = Dataset('sg579_JanApr_L2_5m.nc','w')
...
nc_PAR = NC.createVariable('PAR',np.dtype('float64').char,('cast','pressure'),fill_value=FILL_VALUE)
nc_PAR.units = nc.variables['PAR'].units
...
nc_PAR_n = NC.createVariable('n_PAR',np.dtype('int8').char,('cast','pressure'),fill_value=FILL_VALUE)
