...
```python
data = loadmat('sg510_AprSep.mat')['data'][0,0]
```
...
```python
nc = Dataset('sg510_AprSep_L1.nc','w')
...
nc.comment = 'Code to create file at: https://github.com/zerickso/seaglider-processing/OSMOSIS_Level1_SG510_AprSep.html'
...
```python
ONE_DIVE_TIME_THRESHOLD = 6./24 # hours
ONE_DIVE_LAT_THRESHOLD  = 0.05 # deg N
ONE_DIVE_LON_THRESHOLD  = 0.1 # deg E
TWO_DIVE_TIME_THRESHOLD = 10./24 # hours
TWO_DIVE_LAT_THRESHOLD = 0.05 # deg N
TWO_DIVE_LON_THRESHOLD = 0.1 # deg E

TEMP_THRESHOLD_HIGH = 0.025; # deg C
TEMP_THRESHOLD_LOW = 0.01; # deg C
SAL_THRESHOLD_HIGH = 0.025; # PSU
SAL_THRESHOLD_LOW = 0.01; # PSU
OXY_THRESHOLD_HIGH = 10.; # micromol/kg
OXY_THRESHOLD_LOW = 5.; # micromol/kg

DEPTH_THRESHOLD = 2; # db
SPEED_THRESHOLD = 0.02; # db/s

TEMP_RANGE = [6,16] # deg C
SAL_RANGE = [32.,36.] # PSU
#OXY_RANGE = [50., 300.] # micromol/kg
F_RANGE = [-np.inf,np.inf]; # mg/m^3
BBP_RANGE = [0,4e-4]; # 1/m
CDOM_RANGE = [-np.inf,np.inf]; # ppm

SAL_MEAN_THRESHOLD = 35.; # PSU
...
```
    ...
    <matplotlib.collections.PathCollection at 0x1203a32e8>




![png](Level1_SG510_AprSep/output_8_1.png)
...
```
    ...
    <matplotlib.text.Text at 0x1206f9cf8>




![png](Level1_SG510_AprSep/output_11_1.png)
...
![png](Level1_SG510_AprSep/output_14_0.png)
...
![png](Level1_SG510_AprSep/output_17_0.png)
...
![png](Level1_SG510_AprSep/output_18_0.png)



```python
bad_dive = np.where(time[:,0]<145)[0][-2]
...
![png](Level1_SG510_AprSep/output_19_1.png)


Flag the whole upcast of this dive as bad
...
oxy = [];
oxy_flag = [];
all_oxygen_data = loadmat('SG510_AprSep_gfm_spk_salcal_chlcal_oxycal.mat')['SG510'][0,0]['hydrography']['oxy_calibrated']
for i in range(len(data['hydrography'])):
...
![png](Level1_SG510_AprSep/output_24_0.png)
...
![png](Level1_SG510_AprSep/output_27_0.png)
...
![png](Level1_SG510_AprSep/output_30_0.png)
...
![png](Level1_SG510_AprSep/output_33_0.png)
...
![png](Level1_SG510_AprSep/output_34_0.png)
...
```
    ...
    <matplotlib.collections.PathCollection at 0x1240779b0>




![png](Level1_SG510_AprSep/output_37_1.png)
