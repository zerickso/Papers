...
```
    ...
    OrderedDict([('GPS_lat', <class 'netCDF4._netCDF4.Variable'>
                  ...
                  unlimited dimensions: 
                  current shape = (427, 1624)
                  filling on, default _FillValue of 255 ignored), ('CDOM',
                  <class 'netCDF4._netCDF4.Variable'>
                  ...
                  unlimited dimensions: 
                  current shape = (427, 1624)
                  filling on), ('CDOM_flag', <class 'netCDF4._netCDF4.Variable'>
...
![png](Level2_SG533_AprSep_2m/output_6_1.png)
...
![png](Level2_SG533_AprSep_2m/output_7_1.png)
...
![png](Level2_SG533_AprSep_2m/output_9_0.png)
...
![png](Level2_SG533_AprSep_2m/output_10_0.png)
...
![png](Level2_SG533_AprSep_2m/output_12_0.png)
...
```
    ...
    [<matplotlib.lines.Line2D at 0x10cc472e8>]




![png](Level2_SG533_AprSep_2m/output_14_1.png)
...
```
    ...
    [<matplotlib.lines.Line2D at 0x10c1a59b0>]




![png](Level2_SG533_AprSep_2m/output_16_1.png)
...
![png](Level2_SG533_AprSep_2m/output_18_0.png)
...
NC = Dataset('sg533_AprSep_L2_2m.nc','w')
